    ...
    function populateTable(data) {
        ...
        data.forEach((item, index) => {
            ...
            if (item["Geoserver Title"] === 'Not available') {
                ...
                item["hasRedBackground"] = true;  // Add this property to indicate the row should be red
            } else {
                item["hasRedBackground"] = false; // Ensure the property is added even if false
            }
