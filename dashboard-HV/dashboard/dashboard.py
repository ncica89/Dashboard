            ...
            for workspace in workspaces:
                    ...
                    for datastore in datastores:
                        ...
                        if response.status_code == 200:
                            ...
                            for entry in root.find('connectionParameters'):
                                try:
                                    if entry.attrib.get('key') == 'host' or entry.attrib.get('key') == 'RepositoryClassName' or entry.attrib.get('key') == 'jndiReferenceName' or entry.attrib.get('key') == 'url':
                ...
                if response.status_code == 200 and response.json()['coverageStores']:
                    ...
                    for coveragestore in coveragestores:
                        ...
                        coveragestore_url = f"{BASE_URL}/resource/workspaces/{workspace_name}/{coveragestore_name}/datastore.xml"
        ...
        if admin_response:
            ...
            for layer in admin_response:
                if item['Geoserver WMS name'] == layer['layersBodId']:
                    ...
                    merged_item['Server'] = find_source_for_stora(gs_stores_response, item['Source'])
